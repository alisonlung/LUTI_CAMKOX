...
def flows_map_creation(inputs, outputs, flows_output_keys): # Using OSM
    ...
    Case_Study_Zones = ["Oxfordshire", "Buckinghamshire", "City of Milton Keynes", "Northamptonshire", "Bedfordshire", "Cambridgeshire", "Hertfordshire", "Greater London"]
...
def flows_map_creation_light(inputs, outputs, flows_output_key, network_input):
    ...
    # Write shapefile
    # outdir = "./Outputs-CAMKOXordshire/"+ flows_output_key + "FlowMap_shape"
