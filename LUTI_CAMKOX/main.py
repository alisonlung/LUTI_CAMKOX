...
from LUTI_CAMKOX.databuilder import ensureFile, changeGeography
# from LUTI_CAMKOX.databuilder import geolytixRegression, geolytixOpenDataRegression, geocodeGeolytix, computeGeolytixCosts
from LUTI_CAMKOX.databuilder import buildTotalPopulationTable
from LUTI_CAMKOX.quantjobsmodel import QUANTJobsModel
from LUTI_CAMKOX.costs import costMSOAToPoint_3modes
from LUTI_CAMKOX.analytics import graphProbabilities, flowArrowsGeoJSON
...
def start_main(inputs, outputs):
    ...
    if create_flow_maps:
        flows_output_keys = ["JobsTijRoads2021", "JobsTijBus2021", "JobsTijRail2021", "JobsTijRoads2050", "JobsTijBus2050", "JobsTijRail2050", "NS_JobsTijRoads2050", "NS_JobsTijBus2050", "NS_JobsTijRail2050"]
        ...
        #flows_map_creation_light(inputs, outputs, "JobsTijRail2021", inputs["RoadNetworkShapefile"]) # 2021 Jobs Rail
        ...
        #flows_map_creation_light(inputs, outputs, "JobsTijRail2050", inputs["RoadNetworkShapefile"])  # 2050 Expansion Jobs Rail
        ...
        #flows_map_creation_light(inputs, outputs, "NS_JobsTijRail2050", inputs["RoadNetworkShapefile"])  # 2050 New Settlement Jobs Rail
...
################################################################################
# New housing development scenario (Expansion)                                   
################################################################################
"""
...
def runNewHousingDev(CAMKOX_MSOA_list, zonecodes_EWS, cij_road_CAMKOX, cij_bus_CAMKOX, cij_rail_CAMKOX_2021, cij_rail_CAMKOX_2050, inputs, outputs):
    ...
    # 2050 (proj year): use census (2021) + new houses tot_2021_2050 (it takes into account also the previous years)
    ...
    # Now run the JtW model with 2011 beta and 2021 pop (without calibration this time)
    #New Housing Development - Expansion
...
# CAMKOX = Cambridge + Milton Keynes + Oxford + London (included for analysis)
